...
export class Analytics implements IAnalytics {
   ...
   */
  incrementImpressions(count: number = 1): void {
   ...
   */
  incrementCompletedViews(count: number = 1): void {
   ...
   */
  incrementPartialViews(count: number = 1): void {
  ...
  static create(params: {
    ...
    return new Analytics({
      ...
      engagementMetrics:
        params.engagementMetrics ?? EngagementMetrics.createEmpty(),
